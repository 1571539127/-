...
<body>
	<div class="container">
    			...
    			<div class="layui-form-mid layui-word-aux">
    				<img id="logoid" src="/view/img/11.jpg" height="35">    				
    			</div>
			  ...
			  <div class="">
			  <input id="code" type="text" style="margin-left: 27px;" placeholder="请输入验证码"/>
			  <img src="data:image/png;base64,${code}" id="codeImg" onclick="code()" style="margin-left: 20px;margin-bottom: 10px;"/>
			  </div>
...
<!-- 			  <div class="layui-form-item">
			  ...
			  <div class="layui-form-item">
			    <div class="layui-input-block">
			      <button class="layui-btn" lay-submit lay-filter="formDemo" onclick="land()">登陆</button>	     
			    </div>
			  </div>
...
// 			$("#code").attr("src","data:image/png;base64,"+respMsg);
// 		}
// 	});
// });
	function code(){
		$.ajax({
			...
			success : function(respMsg) {
				debugger;
				$("#codeImg").attr("src","data:image/png;base64,"+respMsg.message);
			}
		});
	}
function land() {
	...
	$.ajax({
		...
		success : function(respMsg) {
			debugger;
			var a=respMsg.message;
			if(a == "true"){
				$(location).attr('href', 'article/index');
			}else{
				alert(a);
			}
		}
